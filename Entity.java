//This class exists to be inherited, but I've had to alter it a little
//I changed it so it properly registers when something leaves the borders of the map (with a little leeway) and throws an exception
